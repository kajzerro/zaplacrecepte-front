            ...
            <div className="row fullscreen">
              <div className="col-6">
                ...
                <div className="statue">
                  <img src="statuePage/satuePicture.svg"/>

                  <br/>
                  <h1 className="zr-header">Regulamin</h1>
                  <br/> <br/>
                  <h4 className="zr-header">§1. Postanowienia ogólne</h4>
                  <ol>
                    <li>Definicje:
                      <ol>
                  ...
                  <h4 className="zr-header">§2. Rodzaje i zakres Usług</h4>
                  <ol>
                  ...
                  <h4 className="zr-header">§3. Warunki świadczenia usług</h4>
                  <ol>
                  ...
                  <h4 className="zr-header">§4. Profile Placówek, zweryfikowane Profile</h4>
                  <ol>
                  ...
                  <h4 className="zr-header">§5. Warunki zawierania i rozwiązywania umów o świadczenie usług. Rejestracja i logowanie.</h4>
                  <ol>
                  ...
                  <h4 className="zr-header">§6. Odpowiedzialność</h4>
                  <ol>
                  ...
                  <h4 className="zr-header">§7. Tryb zgłaszania zastrzeżeń i postępowania reklamacyjnego</h4>
                  <ol>
                  ...
                  <h4 className="zr-header">§8. Postanowienia końcowe</h4>
                  <ol>
