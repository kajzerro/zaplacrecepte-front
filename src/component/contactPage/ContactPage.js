    ...
    return (
        ...
        <div className="contact-page container-fluid">
            <div className="row fullscreen">
                <div className="col-6 blue-background">
                    ...
                    <div className="row centered-body-wrapper left-site">
                        <div className="col-12">
                            <h1 className="zr-header">Skontaktuj się z nami!</h1>
                            <div className="input-frame">
                                <div className="zr-header-description">Skorzystaj z formularza kontaktowego
                                    lub poniższych danych,
                                    a my rozwiążemy
                                    Twój problem.
                                    <br/>
                                    <br/>
                ...
                <img className={"image-on-footer"} src={"/contactPage/bottom-image.svg"}/>
                <ZrFooter/>
            </div>
